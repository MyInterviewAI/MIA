...
define('G5_MYSQL_USER', 'myai');
define('G5_MYSQL_PASSWORD', 'whdals7721!');
define('G5_MYSQL_DB', 'myai');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'myai');

define('G5_TOKEN_ENCRYPTION_KEY', '40251a4e07b364093339c8179bcad9da'); // 토큰 암호화에 사용할 키
