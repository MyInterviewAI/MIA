                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?php echo $qaconfig['qa_title']; ?> 작성</h3>
                        ...
                        <form name="fwrite" id="fwrite" action="<?php echo $action_url ?>" onsubmit="return fwrite_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off">
                            ...
                            <div class="form_01">
                                <ul>
                                    ...
                                    <span class="bo_w_select write_div">
                                        <label for="qa_category" class="sound_only">분류<strong>필수</strong></label>
                                        <select name="qa_category" id="qa_category" required class="btn btn-outline-secondary">
                                    ...
                                    <span class="qa_content_wrap <?php echo $is_dhtml_editor ? $config['cf_editor'] : ''; ?>">
                            ...
                            <div class="btn_confirm write_div">
                                <a href="<?php echo $list_href; ?>" class="btn btn-outline-secondary btn_cancel">취소</a>
                                <button type="submit" id="btn_submit" accesskey="s" class="btn btn-primary btn_submit">작성완료</button>
                            </div>                            
                            </form>
                        </div><!-- /.card-body -->
