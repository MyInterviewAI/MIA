    ...
    <header>
	    ...
	    <div id="ans_add">
			...
			<ul class="more_add">
				...
				<a href="<?php echo $answer_update_href; ?>" class="btn_b01 btn" title="답변수정">답변수정</a>
				<?php } ?>
				<?php if($answer_delete_href) { ?>
				<a href="<?php echo $answer_delete_href; ?>" class="btn_b01 btn" onclick="del(this.href); return false;" title="답변삭제">답변삭제</a>
				<?php } ?>	
			</ul>
			<script>
				// 답변하기 옵션
