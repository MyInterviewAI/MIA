...
<div class="content-wrapper">
    ...
    <!-- Main content { -->
    <section id="bo_vc" class="content">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <!-- Default box -->
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                <?php if ($category_name) { ?>
                                    <span class="btn btn-outline-secondary"><?php echo $view['ca_name']; // 분류 출력 끝 ?></span> 
                                <?php } ?>
                        ...
                        <div class="card-body">
                            ...
                            <article>
                                ...
                                <div class="profile_info_ct">
                                    <span class="sound_only">작성자</span> <?php echo $view['name']; ?><?php if ($is_ip_view) { echo "&nbsp;($ip)"; } ?><br>
                        ...
                        <div class="card-footer">
                            <?php if ($prev_href || $next_href) { ?>
                                <table class="table bo_v_nb">
                                    <?php if ($prev_href) { ?><tr><td class="btn_prv"><span class="nb_tit"><i class="fa fa-chevron-up" aria-hidden="true"></i> 이전글</span> &nbsp;&nbsp;<a href="<?php echo $prev_href ?>"><?php echo $prev_wr_subject;?></a> <span class="nb_date float-right"><?php echo str_replace('-', '.', substr($prev_wr_date, '0', '10')); ?></span></td></tr><?php } ?>
                                    <?php if ($next_href) { ?><tr><td class="btn_next"><span class="nb_tit"><i class="fa fa-chevron-down" aria-hidden="true"></i> 다음글</span> &nbsp;&nbsp;<a href="<?php echo $next_href ?>"><?php echo $next_wr_subject;?></a>  <span class="nb_date float-right"><?php echo str_replace('-', '.', substr($next_wr_date, '0', '10')); ?></span></td></tr><?php } ?>
                            </table>
                            <?php } ?>
                        </div><!-- /.card-footer-->
                    </div><!-- /.card -->
