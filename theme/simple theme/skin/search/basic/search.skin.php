            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">전체검색 결과</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><strong>"<?php echo $stx; ?>"</strong> 전체검색 결과</h3>
                        ...
                        <div class="card-body">
                            ...
                            <section id="sch_res_ov">
                                ...
                                <ul>
                                    <span>게시판 <?php echo $board_count ?>개</span> | 
                                    <span>게시물 <?php echo number_format($total_count) ?>개</span> - 
                                    <span><?php echo number_format($page) ?>/<?php echo number_format($total_page) ?> 페이지 열람 중</span>
                                </ul>
                            </section>
                            <?php
                                }
