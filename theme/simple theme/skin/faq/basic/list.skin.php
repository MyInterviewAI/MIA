...
<!-- FAQ 시작 { -->
<?php
if ($himg_src) { echo '<div id="faq_himg" class="faq_img"><img src="'.$himg_src.'" alt=""></div>'; }
// 상단 HTML
                                    ...
                                    <ol>
                                        ...
                                        <li>
                                            <h5>
                                                ...
                                                <button class="btn btn-default float-right tit_btn" onclick="return faq_open(this);"><i class="fa fa-plus" aria-hidden="true"></i><span class="sound_only">열기</span></button>
                                            </h5>
                                            <div class="con_inner">
                                                <?php echo conv_content($v['fa_content'], 1); ?>
                                                <button type="button" class="btn btn-default closer_btn"><i class="fa fa-minus" aria-hidden="true"></i><span class="sound_only">닫기</span></button>
                                            </div>
                                        </li>
                                        <?php
                                        }
